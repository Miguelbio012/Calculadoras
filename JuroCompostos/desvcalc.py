...
montante = capital * (1 - taxaJC) ** tempoMes #Prestar atenção que os códigos podem ser iguais porém, na fórmula presente no código, analise o final de subtração onde tem (1 - taxaJC).
